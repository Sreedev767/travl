...
!function() {
  ...
  function o(t, r, i) {
      function o(t, r) {
          ...
          !e.getShaderParameter(i, e.COMPILE_STATUS))
              throw new Error("compile error: " + e.getShaderInfoLog(i));
          return i
      }
      var n = {};
      if (n.id = e.createProgram(),
      e.attachShader(n.id, o(e.VERTEX_SHADER, t)),
      e.attachShader(n.id, o(e.FRAGMENT_SHADER, r)),
      e.linkProgram(n.id),
      !e.getProgramParameter(n.id, e.LINK_STATUS))
          throw new Error("link error: " + e.getProgramInfoLog(n.id));
      n.uniforms = {},
      n.locations = {},
      e.useProgram(n.id),
      e.enableVertexAttribArray(0);
      for (var a, s, u = /uniform (\w+) (\w+)/g, h = t + r; null != (a = u.exec(h)); )
          s = a[2],
          n.locations[s] = e.getUniformLocation(n.id, s);
      return n
  }
  function n(t, r) {
  ...
  var s = function() {
      ...
      i.push(o("float", e.FLOAT, Float32Array)),
      ...
      for (var s = null, u = 0; u < i.length; u++)
          if (e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, 32, 32, 0, e.RGBA, i[u].type, null),
  ...
  var h = function(r, i) {
      ...
      this.context = e = n.getContext("webgl") || n.getContext("experimental-webgl"),
      ...
      for (var a = s.arrayType, u = a ? new a(this.resolution * this.resolution * 4) : null, h = 0; h < 2; h++) {
          ...
          e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, s.linearSupport ? e.LINEAR : e.NEAREST),
          e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, s.linearSupport ? e.LINEAR : e.NEAREST),
          e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE),
          e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE),
          e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, this.resolution, this.resolution, 0, e.RGBA, s.type, u),
  ...
  h.prototype = {
      ...
      computeTextureBoundaries: function() {
          ...
          c = i(c) ? e.top + (e.height - u) * parseFloat(c) / 100 : e.top + parseFloat(c);
      ...
      drop: function(t, r, i, o) {
          ...
          e.uniform2fv(this.dropProgram.locations.center, h),
          e.uniform1f(this.dropProgram.locations.radius, i),
          e.uniform1f(this.dropProgram.locations.strength, o),
          this.drawQuad(),
          this.swapBufferIndices()
      },
      updateSize: function() {
  ...
  ,
  t.fn.ripples.Constructor = h,
  t.fn.ripples.noConflict = function() {
      return t.fn.ripples = c,
      this
  }
}();
